		...
		<div id="page-wrapper">			
			<div class="row">	
				...
				<div class="panel panel-red">
					...
					<form name="frm">
						...
						<!-- 성과평가(S)-->				
							<tr align="center">
								...
								<td colspan="2"><b>성과평가 1차</b></td>
								<td colspan="6"><b>성과평가 Comment</b></td>
							</tr>
							<tr align="center">								
								<td colspan="2">
									<input type="text" name="performScore" id="performScore1" class="form-control" value="<%=performanceValue.getPerfomScore1()%>" maxlength="2"  onKeyDown="numberChk(event)" onKeyUp="checkLimit(this)" onFocus="onFocusBlank(this);" onBlur="outFocusValue(this);"/>
								</td>
								<td colspan="6">
									<textarea class="form-control" name="performComments" id="performComments1" style="height: 50px; resize:none;"><%= (performanceValue.getPerformComments1() != null)? performanceValue.getPerformComments1() : ""  %></textarea>									
								</td>
							</tr>
						<!-- 성과평가(E)-->
						...
						<!-- row1(S)-->						 
							<tr align="center" style="<%=display%>">								
								...
								<td colspan="2">									
									<div class=""><input type="checkbox" class="form-control" name="values1[]" <%=((performanceValue.getValueScore1().get(0))? "checked" : "") %>/></div>
								</td>
								<td colspan="4" rowspan="16" >
									<textarea class="form-control" name="valueComments" id="valueComments1" style="height: 1000px; resize:none;"><%= (performanceValue.getValueComments1() != null)? performanceValue.getValueComments1() : ""  %></textarea>
								</td>
							</tr>
						...
						<!-- row2(S)-->	
							<tr align="center" style="<%=display%>">
								...
								<td colspan="2">									
									<div class=""><input type="checkbox" class="form-control" name="values1[]" <%=((performanceValue.getValueScore1().get(1))? "checked" : "") %>/></div>
								</td>
							</tr>
							<tr align="left" style="<%=display%>">								
								<td colspan="4">
						...
						<!-- row3(S)-->		
							<tr align="center" style="<%=display%>">
								...
								<td colspan="2">									
									<div class=""><input type="checkbox" class="form-control" name="values1[]" <%=((performanceValue.getValueScore1().get(2))? "checked" : "") %>/></div>
								</td>
							</tr>
							<tr align="left" style="<%=display%>">								
								<td colspan="4">
						...
						<!-- row4(S)-->		
							<tr align="center" style="<%=display%>">
								...
								<td colspan="2">									
									<div class=""><input type="checkbox" class="form-control" name="values1[]" <%=((performanceValue.getValueScore1().get(3))? "checked" : "") %>/></div>
								</td>
							</tr>
							<tr align="left" style="<%=display%>">								
								<td colspan="4">
						...
						<!-- row5(S)-->		
							<tr align="left" style="<%=display%>">
								...
								<td colspan="2">									
									<div class=""><input type="checkbox" class="form-control" name="values1[]" <%=((performanceValue.getValueScore1().get(4))? "checked" : "") %>/></div>
								</td>
							</tr>
							<tr align="left" style="<%=display%>">								
								<td colspan="4">
						...
						<!-- row6(S)-->		
							<tr align="center" style="<%=display%>">
								...
								<td colspan="2">									
									<div class=""><input type="checkbox" class="form-control" name="values1[]" <%=((performanceValue.getValueScore1().get(5))? "checked" : "") %>/></div>
								</td>
							</tr>
							<tr align="left" style="<%=display%>">								
								<td colspan="4">
						...
						<!-- row7(S)-->		
							<tr align="center" style="<%=display%>">
								...
								<td colspan="2">									
									<div class=""><input type="checkbox" class="form-control" name="values1[]" <%=((performanceValue.getValueScore1().get(6))? "checked" : "") %>/></div>
								</td>
							</tr>
							<tr align="left" style="<%=display%>">								
								<td colspan="4">
						...
						<!-- row8(S)-->		
							<tr align="center" style="<%=display%>">
								...
								<td colspan="2">									
									<div class=""><input type="checkbox" class="form-control" name="values1[]" <%=((performanceValue.getValueScore1().get(7))? "checked" : "") %>/></div>
								</td>
							</tr>
							<tr align="left" style="<%=display%>">								
								<td colspan="4">
					...
					<div class="panel-body" align="right"><div class="col-xs-2 pull-right"><button type="button" class="btn btn-danger btn-sm btn-block" id="searchBtn" name="searchBtn" onClick="SavePerformData(1);">상신</button></div>
