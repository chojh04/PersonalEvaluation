	...
	<tbody>
		...
		<!-- 점수출력 (E)-->
			...
			<td width="7%">				
				...
				<button type="button" class="btn btn-success btn-sm btn-block" onClick="moveConfirm('/performanceDataAdmin','<%=performanceValue.getEmployeId()%>');">평가확인</button>
